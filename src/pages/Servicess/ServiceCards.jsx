                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service) => {
                        ...
                        return (
                            <div
                                key={service.id}
                                className="card-angled group relative bg-[#E4E4E4] inset-shadow-3xl h-[400px] sm:h-[450px] w-full sm:w-[350px] rounded-t-[2rem] hover:shadow-2xl transition-all duration-300 overflow-hidden"
                                style={{
